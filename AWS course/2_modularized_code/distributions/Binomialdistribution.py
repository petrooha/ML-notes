...
class Binomial(Distribution):
    ...
    def replace_stats_with_data(self):
        ...
        #           defined previously.
        self.data = Gaussian.read_data_file(self, file_name)
        self.n = len(self.data)
        self.p = sum(self.data)
        self.mean = calculate_mean(self.data)
        self.stdev = calculate_stdev(self.data)
    ...
    def __add__(self, other):
        ...
        result.p = self.p
        result.mean = (self.mean*self.n + other.mean*other.n) / result.n

...
class LinearSystem(object):
    ...
    def add_multiple_times_row_to_row(self, coefficient, row_to_add, row_to_be_added_to):
        a = self[row_to_add].normal_vector
        d = self[row_to_be_added_to].normal_vector
        k = self[row_to_add].constant_term
        n = self[row_to_be_added_to].constant_term
        new_a = a.times_scalar(coefficient)
        new_normal_vector = new_a.plus(d)
        new_constant_term = k*coefficient + n

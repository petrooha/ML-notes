...
def __eq__(self, ell):
    if self.normal_vector.is_zero():
        if not ell.normal_vector.is_zero():
            ...
            returnMyDecimal(diff).is_near_zero()
    elif ell.normal_vector.is_zero():
        return False


    if not is_parallel_to(self, ell):
        return False
    x0 = self.basepoint
    y0 = ell.basepoint
    ...
    n = self.normal_vector
    #if degree(n, basediff) == 90 or degree(n, basediff) == 270:
...
def intersection_with(self, ell):
    ...
    one_over_denom = Decimal('1')/(A*B - B*C)
...
print "intersection 1: ", intersection_with(ell1, ell2)
print is_parallel_to(ell1, ell2)
print __eq__(ell1, ell2)
...
print "intersection 2: ", intersection_with(ell1, ell2)
print is_parallel_to(ell1, ell2)
print __eq__(ell1, ell2)
...
print "intersection 3: ", intersection_with(ell1, ell2)
print is_parallel_to(ell1, ell2)
print __eq__(ell1, ell2)
